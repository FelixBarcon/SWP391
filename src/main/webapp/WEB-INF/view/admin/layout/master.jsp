<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            ...
            <title>
                <c:if test="${not empty pageTitle}">${pageTitle} - </c:if>ShopMart Admin
            </title>

            <!-- Favicon -->
            <link rel="icon" type="image/x-icon" href="<c:url value='/resources/admin/images/favicon.ico'/>">
            ...
            <!-- Meta Tags for SEO -->
            <meta name="description" content="ShopMart Admin Panel - Quản lý hệ thống bán hàng trực tuyến">
            <meta name="keywords" content="admin, quản lý, bán hàng, e-commerce">
                        ...
                        <c:if test="${not empty pageTitle}">
                            <div class="page-header mb-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h1 class="page-title h3 mb-1">${pageTitle}</h1>
                                        <c:if test="${not empty pageDescription}">
                                            <p class="page-description text-muted mb-0">${pageDescription}</p>
                                        </c:if>
                                    </div>
